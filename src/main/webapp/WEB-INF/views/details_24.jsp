        ...
        <main id="content" class="content">
            ...
            <div class="searchCont">
                ...
                <div class="search totalSearch">
                    <form action="/search/24" class="totalSearch">
                        <fieldset>
                ...
                <div class="inner">
                    <section>
                        ...
                        <ul class="tab tab-type03 tab-size05">
                            ...
                            <li class="current"><a href="/search/24?q=${searchForm.q}">의학칼럼</a></li>
                        ...
                        <!-- search -->
                        <div class="search">
                            <form action="/search/24" id="detailSearch">
                                <fieldset>
                                    <legend>기간 검색</legend>
                                    <em>기간</em>
                                    <!-- date-group -->
                        ...
                        <div class="heading heading-depth03">
                            <h3 class="title">의학 칼럼<span class="color01">${total}</span></h3>
                        </div>
                        <!-- //heading-depth03 -->
                        <!-- boardCard -->
                        <ul class="boardCard">
                            <c:forEach var="item" items="${items}">
                                <li>
                                    ...
                                    <a href="/" class="item ani-scale">
                                        ...
                                        <!-- item-body -->
                                        <div class="item-body">
                                            <span class="underline-ctg">${item.subcat}</span>
