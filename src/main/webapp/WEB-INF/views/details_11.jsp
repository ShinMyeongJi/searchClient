                ...
                <div class="inner">
                    <section>
                        ...
                        <ul class="tab tab-type03 tab-size05">
                            ...
                            <li class="current"><a href="/search/11?q=${searchForm.q}">의약품정보</a></li>
                        ...
                        <!-- search -->
                        <div class="search">
                            <form action="/search/11" id="detailSearch">
                                <fieldset>
                                    <legend>기간 검색</legend>
                                    <em>기간</em>
                                    <!-- date-group -->
                        ...
                        <div class="heading heading-depth03">
                            <h3 class="title">질환백과 <span class="color01">${total}</span></h3>
                        </div>
                        <!-- //heading-depth03 -->
                        <!-- board-dic -->
                        <div class="board-dic">
