                ...
                <div class="inner">
                    <section>
                        ...
                        <ul class="tab tab-type03 tab-size05">
                            ...
                            <li class="current"><a href="/search/23?q=${searchForm.q}">건강포인트</a></li>
                        ...
                        <!-- search -->
                        <div class="search">
                            <form action="/search/23" id="detailSearch">
                                <fieldset>
                                    <legend>기간 검색</legend>
                                    <em>기간</em>
                                    <!-- date-group -->
                        ...
                        <div class="heading heading-depth03">
                            <h3 class="title">건강 포인트 <span class="color01">${total}</span></h3>
                        </div>
                        <!-- //heading-depth03 -->
                        <!-- boardCard -->
                        <ul class="boardCard">
