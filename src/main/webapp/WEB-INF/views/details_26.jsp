                ...
                <div class="inner">
                    <section>
                        ...
                        <ul class="tab tab-type03 tab-size05">
                            ...
                            <li class="current"><a href="/search/26?q=${searchForm.q}">동네사람들 건강이야기</a></li>
                        ...
                        <!-- search -->
                        <div class="search">
                            <form action="/search/26" id="detailSearch">
                                <fieldset>
                                    <legend>기간 검색</legend>
                                    <em>기간</em>
                                    <!-- date-group -->
                        ...
                        <div class="heading heading-depth03">
                            <h3 class="title">동네사람들 건강이야기 <span class="color01">${total}</span></h3>
                        </div>
                        <!-- //heading-depth03 -->
                        <!-- table -->
                            ...
                            <table>
                                ...
                                <c:forEach var="item" items="${items}">
                                    <tr>
                                        ...
                                        <td class="color05 verticalT">${item.wdate}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
