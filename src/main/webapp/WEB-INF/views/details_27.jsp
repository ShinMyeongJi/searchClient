                ...
                <div class="inner">
                    <section>
                        ...
                        <ul class="tab tab-type03 tab-size05">
                            ...
                            <li class="current"><a href="/search/27?q=${searchForm.q}">이벤트</a></li>
                        </ul>
                        <!-- //tab -->
                        ...
                        <!-- search -->
                        <div class="search">
                            <form action="/search/27" id="detailSearch">
                                <fieldset>
                                    <legend>기간 검색</legend>
                                    <em>기간</em>
                                    <!-- date-group -->
                        ...
                        <div class="heading heading-depth03">
                            <h3 class="title">이벤트<span class="color01">${total}</span></h3>
                        </div>
                        <!-- //heading-depth03 -->
                        <!-- card -->
                            ...
                            <c:forEach var="item" items="${items}">
                                <li>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-bar">
                                                <li class="color01">${item.subcat}</li>
                                            </ul>
                                            <a href="/" class="title">
                                                    ${item.name}
                                            </a>
                                            ...
                                            <div class="card-foot">${item.wdate}</div>
                                        </div>
                                    </div>
                                    <!-- //item -->
                                </li>
